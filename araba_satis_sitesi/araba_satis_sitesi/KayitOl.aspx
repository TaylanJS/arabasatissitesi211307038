<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="KayitOl.aspx.cs" Inherits="araba_satis_sitesi.KayitOl" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="nav-justified">
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="btnKayit" runat="server" OnClick="btnKayit_Click" Text="Kayıt Ol" Width="127px"  style="border-radius:5px;margin-bottom:5px; height:30px" />
            </td>
        </tr>
    </table>
</form>
